...
| **E5** · Evaluación heurística y WCAG | [e5-evaluacion-heuristica.md](e5-evaluacion-heuristica.md) · [formularios](anexo-c-formularios-e5.md) | 22 hallazgos, auditoría WCAG 2.2 medida en el prototipo web; formularios para las cuatro evaluaciones, antes/después y design review |
