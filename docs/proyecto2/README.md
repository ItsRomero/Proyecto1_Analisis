...
| **Panel gerencial web** | [P2-panel-gerencial-web.md](P2-panel-gerencial-web.md) | Skeletons y wireframes anotados W01 Dashboard, W02 Cartera y W03 Clientes, medidos del [prototipo web de Figma](https://www.figma.com/make/WHj2TK5IRg55X8JiaKXyvy/Prototipo-Microcr%25C3%25A9ditos-Web?code-node-id=0-6&p=f&fullscreen=1) |
...
| **E3** · Prototipos en Figma | [e3-prototipo-figma.md](e3-prototipo-figma.md) · [prototipo móvil](https://www.figma.com/proto/jozM3QI8ZJ6pywdCoO5OVo/Microcr%C3%A9ditos-App?node-id=0-1&t=PJlTVLC3ASu31ttw-1) · [prototipo web](https://www.figma.com/make/WHj2TK5IRg55X8JiaKXyvy/Prototipo-Microcr%25C3%25A9ditos-Web?code-node-id=0-6&p=f&fullscreen=1) | Recorrido de los tres flujos, correspondencia con las pantallas obligatorias y cifras a corregir (Anexo B con instrucciones para Figma Make) |
...
| **E5** · Evaluación heurística y WCAG | [e5-evaluacion-heuristica.md](e5-evaluacion-heuristica.md) · [formularios](anexo-c-formularios-e5.md) | 25 hallazgos, auditoría WCAG 2.2 medida en los prototipos web; formularios para las cuatro evaluaciones, antes/después y design review |
