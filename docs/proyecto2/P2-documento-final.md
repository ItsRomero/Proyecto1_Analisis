...
| Experiencia de usuario y entrega | 23/09 | 12 – 21 | E1, E2, E4, wireframes, revisión E3/E5, historial y documento de entrega |
...
Cada pantalla aparece dos veces, a partir de la misma descripción: a la izquierda el **skeleton** (solo bloques) y a la derecha el **wireframe anotado** (textos, cifras del núcleo y notas numeradas). Primero van las 14 pantallas del prototipo de Figma (P01–P14) y después las 7 guías para las pantallas que faltan (G01–G07). Las convenciones y el contenido de cada bloque están en la sección 3.4.3.
